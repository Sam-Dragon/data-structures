...
public class PostfixExpression {
    ...
    public static void main(String[] args) {
        ...
        String expression = convertToPostfixExpression(input);
        System.out.println("Postfix Expression for Input '" + input + "' = " + expression);
    }

    private static String convertToPostfixExpression(String input) {
