...
public class PrefixExpression {
    ...
    public static void main(String[] args) {
        ...
        String expression = convertToPrefixExpression(input);
        System.out.println("Prefix Expression for Input '" + input + "' = " + expression);
    }

    private static String convertToPrefixExpression(String input) {
